...
Yd(c,a,b.cf);if(d)a:if(Dd("ajax_204_success")&&204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(e&&e.return_code,10);break a;case "RAW":d=!0;break a}d=!!e}var e=e||{},f=b.context||l;d?b.R&&b.R.call(f,a,e):b.onError&&b.onError.call(f,a,e);b.Ub&&b.Ub.call(f,a,e)}},b.method,h,b.headers,b.responseType,b.withCredentials);
b.ka&&0<b.timeout&&(m=I(function(){k||(k=!0,n.abort(),J(m),b.ka.call(b.context||l,n))},b.timeout));
return n}
function Yd(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=wd(a));break;case "XML":if(b=(b=b.responseXML)?$d(b):null)d={},B(b.getElementsByTagName("*"),function(a){d[a.tagName]=ae(a)})}c&&be(d);
return d}
...
function pe(a,b){a.classList?a.classList.remove(b):ne(a,b)&&(a.className=Ia(me(a),function(a){return a!=b}).join(" "))}
...
;function Rj(){var a=Re();return a?a:null}
;function Sj(a,b){(a=ze(a))&&a.style&&(a.style.display=b?"":"none",qe(a,"hid",!b))}
...
;var Vj={},Wj="ontouchstart"in document;function Xj(a,b,c){var d;switch(a){case "mouseover":case "mouseout":d=3;break;case "mouseenter":case "mouseleave":d=9}return Oe(c,function(a){return ne(a,b)},!0,d)}
function Yj(a){var b="mouseover"==a.type&&"mouseenter"in Vj||"mouseout"==a.type&&"mouseleave"in Vj,c=a.type in Vj||b;if("HTML"!=a.target.tagName&&c){if(b){var b="mouseover"==a.type?"mouseenter":"mouseleave",c=Vj[b],d;for(d in c.ha){var e=Xj(b,d,a.target);e&&!Oe(a.relatedTarget,function(a){return a==e},!0)&&c.B(d,e,b,a)}}if(b=Vj[a.type])for(d in b.ha)(e=Xj(a.type,d,a.target))&&b.B(d,e,a.type,a)}}
...
g.Ia=function(a){var b=parseInt(E(a,"tooltip-show-timer"),10);b&&(J(b),Jb(a,"tooltip-show-timer"));b=x(function(){if(a){var b=ze(hk(this,a));b&&(ik(b),b&&b.parentNode&&b.parentNode.removeChild(b),Jb(a,"content-id"));(b=ze(hk(this,a,"arialabel")))&&b.parentNode&&b.parentNode.removeChild(b)}Jb(a,"tooltip-hide-timer")},this);
...
function jk(a,b){dk(a,b);a=E(a,"content-id");(a=ze(a))&&He(a,b)}
function gk(a){return E(a,"tooltip-text")||a.title}
function fk(a,b){if(b){var c=gk(b);if(c){var d=ze(hk(a,b));if(!d){d=document.createElement("div");d.id=hk(a,b);d.className=S(a,"tip");var e=document.createElement("div");e.className=S(a,"tip-body");var f=document.createElement("div");f.className=S(a,"tip-arrow");var h=document.createElement("div");h.setAttribute("aria-hidden","true");h.className=S(a,"tip-content");var k=kk(a,b),m=hk(a,b,"content");h.id=m;Hb(b,"content-id",m);e.appendChild(h);k&&d.appendChild(k);d.appendChild(e);d.appendChild(f);var n=
Ke(b),m=hk(a,b,"arialabel"),f=document.createElement("div");oe(f,S(a,"arialabel"));f.id=m;n=b.hasAttribute("aria-label")?b.getAttribute("aria-label"):"rtl"==document.body.getAttribute("dir")?c+" "+n:n+" "+c;He(f,n);b.setAttribute("aria-labelledby",m);m=Rj()||document.body;m.appendChild(f);m.appendChild(d);jk(b,c);(c=parseInt(E(b,"tooltip-max-width"),10))&&e.offsetWidth>c&&(e.style.width=c+"px",oe(h,S(a,"normal-wrap")));h=ne(b,S(a,"reverse"));lk(a,b,d,e,k,h)||lk(a,b,d,e,k,!h);var A=S(a,"tip-visible");
I(function(){oe(d,A)},0)}}}}
...
parseFloat(n),parseFloat(kb),parseFloat(k));f.pixelWidth=h.width-k.left-m.left-m.right-k.right;f.pixelHeight=h.height-k.top-m.top-m.bottom-k.bottom}else f.pixelWidth=h.width,f.pixelHeight=h.height;h=window.document;h=De(h)?h.documentElement:h.body;f=new je(h.clientWidth,h.clientHeight);1==c.nodeType?(c=eg(c),k=new se(c.left,c.top)):(c=c.changedTouches?c.changedTouches[0]:c,k=new se(c.clientX,c.clientY));c=gg(d);n=Math.floor(c.width/2);h=!!(f.height<k.K+a.height);a=!!(k.K<a.height);m=!!(k.J<n);f=!!(f.width<
...
function hk(a,b,c){a=S(a);var d=b.__yt_uid_key;d||(d=Pe(),b.__yt_uid_key=d);b=a+d;c&&(b+="-"+c);return b}
function kk(a,b){var c=null;id&&ne(b,S(a,"masked"))&&((c=ze("yt-uix-tooltip-shared-mask"))?(c.parentNode.removeChild(c),Tj(c)):(c=document.createElement("iframe"),c.src='javascript:""',c.id="yt-uix-tooltip-shared-mask",c.className=S(a,"tip-mask")));return c}
function ik(a){var b=ze("yt-uix-tooltip-shared-mask"),c=b&&Oe(b,function(b){return b==a},!1,2);
...
function pk(a){var b=E(a,nk.gd),c=!!E(a,"is-subscribed"),b="-"+b,d=Ne.ad+b;qe(a,Ne.$c+b,!c);qe(a,d,c);E(a,nk.ed)&&!E(a,nk.dd)&&(b=S(ek.getInstance()),qe(a,b,!c),a.title=c?"":E(a,nk.fd));c?I(function(){oe(a,Ne.$b)},1E3):pe(a,Ne.$b)}
g.qd=function(a){var b=!!E(a,"ypc-item-type"),c=!!E(a,"ypc-item-id");!E(a,"ypc-enabled")&&b&&c&&(oe(a,"ypc-enabled"),Hb(a,nk.jd,"true"))};
g.pd=function(a){E(a,"ypc-enabled")&&(pe(a,"ypc-enabled"),Jb(a,"ypc-enabled"))};
function qk(a,b){return Ia(Ae(S(a)),function(a){return b==E(a,"channel-external-id")},a)}
...
var hl=null;function il(a){return(new mh(function(b){try{var c={gapiHintOverride:a.gapiHintOverride,_c:{jsl:{h:a.gapiHintParams}},callback:b},d=fa(c)?{callback:c}:c||{};d._c&&d._c.jsl&&d._c.jsl.h||mb(d,{_c:{jsl:{h:H("GAPI_HINT_PARAMS",void 0)}}});if(d.gapiHintOverride||H("GAPI_HINT_OVERRIDE")){var e;var f=document.location.href;if(-1!=f.indexOf("?")){var f=(f||"").split("#")[0],h=f.split("?",2);e=Pd(1<h.length?h[1]:h[0])}else e={};var k=e.gapi_jsh;k&&mb(d,{_c:{jsl:{h:k}}})}el("client",d)}catch(m){ic(m)}})).then(function(){})}
...
c=f&&d&&e?[e,ml(kl(f),d,c||null)].join(" "):null;break a}c=null}c&&(b.headers.Authorization=c,b.headers["X-Goog-AuthUser"]=H("SESSION_INDEX",0));a="//"+this.b.Ee+("/youtubei/"+this.b.innertubeApiVersion+"/"+a)+"?alt=json&key="+this.b.innertubeApiKey;b.method="POST";b.O||(b.O={});Xd(a,b)};function Kf(){return Dd("enable_youtubei_innertube")?ol:gl}
...
;var am={Qe:"atp",$e:"ska",Xe:"que",Ve:"mus",Ze:"sus"};function bm(a){this.i=this.g="";this.b="/api/lounge";this.f=!0;a=a||document.location.href;var b=Number(Gd(4,a))||null||"";b&&(this.i=":"+b);this.g=Fd(Gd(3,a))||"";a=nb;0<=a.search("MSIE")&&(a=a.match(/MSIE ([\d.]+)/)[1],0>Ea(a,"10.0")&&(this.f=!1))}
function cm(a,b,c,d){var e=a.b;if(p(d)?d:a.f)e="https://"+a.g+a.i+a.b;return Od(e+b,c||{})}
function dm(a,b,c,d,e){a={format:"JSON",method:"POST",context:a,timeout:5E3,withCredentials:!1,R:ma(a.o,d,!0),onError:ma(a.j,e),ka:ma(a.l,e)};c&&(a.O=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return Xd(b,a)}
...
g.Hc=function(){this.f=NaN;this.b=Xd(cm(this.A,"/pairing/get_screen"),{method:"POST",O:{pairing_code:this.l},timeout:5E3,R:x(this.He,this),onError:x(this.Ge,this),ka:x(this.Ie,this)})};
...
g.Ke=function(a,b,c,d){Xd(cm(this.l,"/pairing/get_screen"),{method:"POST",O:{pairing_code:a},timeout:5E3,R:x(function(a,d){a=new Ul(d.screen||{});if(!a.name||Tm(this,a.name)){a:{d=a.name;for(var e=2,f=b(d,e);Tm(this,f);){e++;if(20<e)break a;f=b(d,e)}d=f}a.name=d}c(Rm(this,a))},this),
...
Xd(cm(a.l,"/pairing/get_lounge_token_batch"),e)}
...
function cn(a){var b={};b.pairingCode=a.L;if(a.j){var c=a.j.currentTime||0;b.v=a.j.videoId;b.t=c}Dm()&&(b.env_useStageMdx=1);return Md(b)}
...
function Bo(a){if(a.f&&"undefined"!=typeof aa)if(a.H[1]&&4==Yn(a)&&2==a.getStatus())a.getStatus();else if(a.l&&4==Yn(a))Gn(a.zc,0,a);else if(ch(a,"readystatechange"),4==Yn(a)){a.getStatus();a.f=!1;try{var b=a.getStatus(),c;a:switch(b){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:c=!0;break a;default:c=!1}var d;if(!(d=c)){var e;if(e=0===b){var f=Gd(1,String(a.$));if(!f&&l.self&&l.self.location)var h=l.self.location.protocol,f=h.substr(0,h.length-1);e=!to.test(f?f.toLowerCase():"")}d=
...
g.w=function(){mp(this);np(this);op(this);J(this.H);this.H=NaN;J(this.L);this.L=NaN;this.g=null;Ue(this.aa);this.aa.length=0;this.b.dispose();Z.C.w.call(this);this.A=this.G=this.f=this.F=this.b=null};
...
function gq(a){Qj()?(R(Dj,new xj(a.externalChannelId,a.Fd?{itemType:"U",itemId:a.externalChannelId}:null)),(a="/gen_204?"+Md({event:"subscribe",source:a.source}))&&ni(a)):hq(a)}
function hq(a){Pj(function(b){b.subscription_ajax&&gq(a)},null)}
function iq(a){a=eq(a);R(Ij,new zj(a.externalChannelId,a.subscriptionId,null));(a="/gen_204?"+Md({event:"unsubscribe",source:a.source}))&&ni(a)}
...
yq.prototype.w=function(){Ue(this.i);this.b=null;yq.C.w.call(this)};var zq=!1;function Aq(a){if(a=a.match(/[\d]+/g))a.length=3}
...
(function(){if(tf)return Bq(/Firefox\/([0-9.]+)/);if(K||fd||ed)return od;if(xf)return Bq(/Chrome\/([0-9.]+)/);if(yf&&!(ad()||D("iPad")||D("iPod")))return Bq(/Version\/([0-9.]+)/);if(uf||vf){var a=/Version\/(\S+).*Mobile\/(\S+)/.exec(nb);if(a)return a[1]+"."+a[2]}else if(wf)return(a=Bq(/Android\s+([0-9.]+)/))?a:Bq(/Version\/([0-9.]+)/);return""})();function Cq(){var a=ib(Dq);return new mh(function(b,c){a.R=function(a){Sd(a)?b(a):c(new Eq("Request failed, status="+a.status,"net.badstatus"))};
a.onError=function(){c(new Eq("Unknown request error","net.unknown"))};
a.ka=function(){c(new Eq("Request timed out","net.timeout"))};
Xd("//googleads.g.doubleclick.net/pagead/id",a)})}
...
function hr(a,b,c,d){var e=new vj(a);R(Ej,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=H("PLAYBACK_ID"))&&(c.plid=d);(d=H("EVENT_ID"))&&(c.ei=d);b&&vr(b,c);Xd("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",Xb:f,O:c,R:function(b,c){b=c.response;R(Gj,new yj(a,b.id,b.channel_info));b.show_feed_privacy_dialog&&tc("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a);b.actions&&Sq(b.actions)},
Ub:function(){R(Fj,e)}})}
function jr(a,b,c,d,e){var f=new vj(a);R(Jj,f);var h={};d&&(h.eurl=d);e&&(h.source=e);d={};d.c=a;d.s=b;(a=H("PLAYBACK_ID"))&&(d.plid=a);(a=H("EVENT_ID"))&&(d.ei=a);c&&vr(c,d);Xd("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",Xb:h,O:d,R:function(a,b){a=b.response;R(Lj,f);a.actions&&Sq(a.actions)},
Ub:function(){R(Kj,f)}})}
...
Xd("/subscription_ajax?action_create_subscription_to_all=1",{method:"POST",O:c,R:function(c,f){d();c=f.response;f=c.id;if(v(f)&&f.length==b.length){var e=c.channel_info_map;B(f,function(a,c){c=b[c];R(Gj,new yj(c,a,e[c]))});
...
Xd("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",O:c,R:function(){d();ur(b,Lj);a.length&&nr(a)},
onError:function(){d()}})}}
function ur(a,b){B(a,function(a){R(b,new vj(a))})}
function vr(a,b){a=Pd(a);for(var c in a)b[c]=a[c]}
...
l.$googDebugFname||f}catch(kb){k="Not available",m=!0}a=!m&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:k,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(d)||(h=h+":"+d);if(!(ce[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){b={Xb:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:h,level:b||"ERROR"},O:{url:H("PAGE_NAME",
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();H("PL_ATT")&&(Fc=null);for(var a=0,b=fe.length;a<b;a++){var c=fe[a];if(!isNaN(c)){var d=r("yt.scheduler.instance.cancelJob");d?d(c):J(c)}}fe.length=0;a=Bc("//static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))wc(a),b.parentNode.removeChild(b);ge=!1;fc("DCLKSTAT",0);sc(er);er.length=0;wi(fr);fr.length=0;dr=!1;cq&&(cq.removeEventListener("SUBSCRIBE",gq),cq.removeEventListener("UNSUBSCRIBE",iq));cq=null;wi(dq);dq.length=0;
Dd("legacy_cast2")&&!zr&&(sc($p),$p.length=0,Zp&&(Zp.removeEventListener("onReady",aq),Zp=null),Np());bc(yr,xr);if(a=wr)a.removeEventListener("onScreenChanged",Ar),a.removeEventListener("onLogServerVeClicked",Br),a.removeEventListener("onLogServerVesShown",Cr),a.destroy()});
